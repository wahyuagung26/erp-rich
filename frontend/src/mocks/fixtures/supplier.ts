...
export const supplierSeed: Supplier[] = [
	...
	// Observed RICH tenant (company 1) suppliers used by the supplier-advance module —
	// codes are the Legacy RC-* codes, not the server-assigned SUP-* format.
	{
		id: 7,
		company_id: 1,
		code: 'RC00001',
		name: 'PT Rahadhyan Integrasi Nusantara',
		address: 'Jl. Kaum Kaler No. 1',
		city: 'Tasikmalaya',
		phone: '',
		fax: '',
		email: '',
	...
	},
	{
		...
		company_id: 1,
		code: 'RC00003',
		name: 'PT Makmur Sejahtera Abadi',
	...
	},
	{
		...
		company_id: 1,
		code: 'RC00007',
		name: 'PT Rahadhyan International Capital Haven',
		address: 'Jl. Kaum Kaler No. 2',
		city: 'Tasikmalaya',
		phone: '',
		fax: '',
		email: '',
