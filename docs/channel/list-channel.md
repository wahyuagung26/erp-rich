...
type: API Endpoint
title: List Channel
description: Paginated, filterable, sortable list of sales channels. Soft-deleted rows are excluded.
method: GET
path: /channel
status: mock
tags: [channel, read, list]
...
Backs `views/channel/pages/PageChannelTable.vue` (via the `useTableList` composable).
