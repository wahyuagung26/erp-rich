...
description: Paginated, filterable, sortable list of account groups. Soft-deleted rows are excluded.
method: GET
path: /account-group
status: mock
tags: [account-group, read, list]
...
Backs `views/account-group/pages/PageAccountGroupTable.vue` (via the `useTableList` composable).
