...
Backs `views/gudang/pages/PageGudangTable.vue` (via the `useTableList` composable).
...
{
  "data": [
    { "id": 1, "company_id": 1, "code": "GD1", "name": "Gudang Pusat", "cabang_id": 1, "cabang_code": "PST", "cabang_name": "Kantor Pusat", "address": "Jl. Kaum Kaler, Manonjaya, Tasikmalaya", "deleted_at": null }
  ],
