...
Backs `views/akun-perkiraan/pages/PageAkunPerkiraanTable.vue` (via the `useTableList` composable).
...
{
  "data": [
    { "id": 1, "company_id": 1, "sub_akun_id": 1, "sub_akun_code": "10001", "sub_akun_name": "Kas", "code": "1000101", "name": "Kas Kecil", "type": "asset", "deleted_at": null }
  ],
