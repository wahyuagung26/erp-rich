...
Backs `views/sub-akun/pages/PageSubAkunTable.vue` (via the `useTableList` composable).
...
{
  "data": [
    { "id": 1, "company_id": 1, "group_akun_id": 1, "group_akun_code": "10", "group_akun_name": "Aset", "code": "10001", "name": "Kas", "normal_balance": "debit", "deleted_at": null }
  ],
